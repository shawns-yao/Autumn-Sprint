...
function currentJobStage(job: Application) {
  return currentWorkflowStage(job) || workflowFor(job).find(stage => stage.id === job.currentStageId || stage.label === normalizedStatus(job))
}
